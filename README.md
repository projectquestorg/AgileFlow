...
[![Commands](https://img.shields.io/badge/commands-127-blue)](https://docs.agileflow.projectquestorg.com/docs/commands)
[![Agents/Experts](https://img.shields.io/badge/agents%2Fexperts-105-orange)](https://docs.agileflow.projectquestorg.com/docs/agents)
...
|-----------|-------|-------------|
| [Commands](https://docs.agileflow.projectquestorg.com/docs/commands) | 127 | Slash commands for agile workflows |
| [Agents/Experts](https://docs.agileflow.projectquestorg.com/docs/agents) | 105 | Specialized agents with self-improving knowledge bases |
