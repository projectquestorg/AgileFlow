...
|----------|-------------|
| [Commands](./commands.md) | All 93 slash commands |
| [Subagents](./subagents.md) | All 45 specialized agents |
...
- **Commands**: 93 slash commands for agile workflows
- **Agents**: 45 domain-specialized experts
