...
|----------|-------------|
| [Commands](./commands.md) | All 81 slash commands |
| [Subagents](./subagents.md) | All 34 specialized agents |
...
- **Commands**: 81 slash commands for agile workflows
- **Agents**: 34 domain-specialized experts
