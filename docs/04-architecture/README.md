...
|----------|-------------|
| [Commands](./commands.md) | All 78 slash commands |
| [Subagents](./subagents.md) | All 31 specialized agents |
...
- **Commands**: 78 slash commands for agile workflows
- **Agents**: 31 domain-specialized experts
