...
|----------|-------------|
| [Commands](./commands.md) | All 94 slash commands |
| [Subagents](./subagents.md) | All 55 specialized agents |
...
- **Commands**: 94 slash commands for agile workflows
- **Agents**: 55 domain-specialized experts
