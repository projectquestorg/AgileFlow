...
AgileFlow includes **31 specialized subagents** that operate in separate context windows for focused work.
...
- [Commands](./commands.md) - 77 slash commands
