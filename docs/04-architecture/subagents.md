...
AgileFlow includes **34 specialized subagents** that operate in separate context windows for focused work.
...
- [Commands](./commands.md) - 81 slash commands
