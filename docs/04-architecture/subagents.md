...
AgileFlow includes **46 specialized subagents** that operate in separate context windows for focused work.
...
- [Commands](./commands.md) - 85 slash commands
