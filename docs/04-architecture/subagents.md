...
AgileFlow includes **55 specialized subagents** that operate in separate context windows for focused work.
...
- [Commands](./commands.md) - 94 slash commands
