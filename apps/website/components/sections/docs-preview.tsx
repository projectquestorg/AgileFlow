            ...
            <Reveal>
              <div className="surface rounded-card shadow-tile">
                ...
                <div className="p-5 sm:p-6">
                  <div className="overflow-x-auto rounded-card border border-[var(--border-default)] bg-[var(--bg-code)] p-4">
                    <div className="code-shiki text-sm" dangerouslySetInnerHTML={{ __html: content.panel.codeHtml }} />
                  </div>
                  <p className="mt-4 text-xs leading-5 text-[var(--text-muted)]">{content.panel.footnote}</p>
                </div>
              </div>
            </Reveal>
          </div>
