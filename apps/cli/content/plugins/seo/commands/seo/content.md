...
<parameter name="questions">[{
  "question": "Content analysis complete: {URL} scored {X}/100. Lowest E-E-A-T factor: {factor} ({score}%). {N} issues found.",
  "header": "Next steps",
  "multiSelect": false,
  "options": [
    {"label": "Fix {top_issue} (Recommended)", "description": "{specific actionable fix — e.g., 'Add author bio with credentials to this page'}"},
    {"label": "Analyze another page for comparison", "description": "Run /agileflow:seo:content on a top-ranking competitor page to see what they do differently"},
    {"label": "Check schema markup on this page", "description": "Run /agileflow:seo:schema to see if structured data is helping or missing"},
    {"label": "Run full site audit", "description": "Get content scores for all pages with /agileflow:seo:audit"}
  ]
}]</parameter>
</invoke>
```
