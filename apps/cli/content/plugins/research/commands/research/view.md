...
**Phase 2: Read & Display** 4. Read the entire file from docs/10-research/ 5. Display full content to user

**Phase 3: Offer Actions** 6. Ask what user wants to do next 7. Route to appropriate command:
