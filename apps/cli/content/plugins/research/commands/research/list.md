...
**Step 2: Display Index** 4. Show table with: Date, Topic, File, Summary 5. Count total research notes 6. Show list to user

**Step 3: Offer Actions** 7. Suggest next steps via quick links or AskUserQuestion 8. Allow user to view, analyze, or create new research
