...
<parameter name="questions">[
  {
    "question": "Configure API quality audit — what should we scan?",
    "header": "Target",
    "type": "text",
    "key": "target",
  ...
  },
  {
    ...
    "multiSelect": false,
    "options": [
      {"label": "Quick — core analyzers, critical violations only (Recommended)", "value": "quick"},
      {"label": "Deep — all analyzers, includes minor issues", "value": "deep"},
  ...
  },
  {
    ...
    "optional": true,
    "options": [
      {"label": "conventions — REST naming, HTTP method usage, URL structure", "value": "conventions"},
      {"label": "errors — error response format, HTTP status codes, error messages", "value": "errors"},
      {"label": "versioning — breaking changes, deprecation strategy, backward compatibility", "value": "versioning"},
      {"label": "pagination — cursor vs offset, page size limits, total count handling", "value": "pagination"},
      {"label": "docs — OpenAPI/Swagger coverage, request/response examples", "value": "docs"}
    ]
  }
]</parameter>
</invoke>
