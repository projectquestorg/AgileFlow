...
<parameter name="questions">[
  {
    "question": "Configure architecture audit — what should we scan?",
    "header": "Target",
    "type": "text",
    "key": "target",
  ...
  },
  {
    ...
    "multiSelect": false,
    "options": [
      {"label": "Quick — core analyzers, high-severity issues only (Recommended)", "value": "quick"},
      {"label": "Deep — all analyzers, includes structural warnings", "value": "deep"},
  ...
  },
  {
    ...
    "optional": true,
    "options": [
      {"label": "coupling — fan-in/fan-out, tight coupling between modules", "value": "coupling"},
      {"label": "layering — layer violations, import direction, separation of concerns", "value": "layering"},
      {"label": "complexity — cyclomatic complexity, file size, nesting depth", "value": "complexity"},
      {"label": "patterns — god objects, feature envy, shotgun surgery", "value": "patterns"},
      {"label": "circular — import cycles, mutual dependencies, barrel cycles", "value": "circular"}
    ]
  }
]</parameter>
</invoke>
