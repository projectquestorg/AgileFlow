...
<parameter name="questions">[
  {
    "question": "Configure accessibility audit — what should we scan?",
    "header": "Target",
    "type": "text",
    "key": "target",
  ...
  },
  {
    ...
    "options": [
      ...
      {"label": "Deep — all analyzers, includes warnings and suggestions", "value": "deep"},
  ...
  },
  {
    ...
    "optional": true,
    "options": [
      {"label": "semantic — heading hierarchy, landmark regions, document structure", "value": "semantic"},
      {"label": "aria — roles, states, properties, live regions, widget patterns", "value": "aria"},
      {"label": "visual — color contrast, motion preferences, text sizing", "value": "visual"},
      {"label": "keyboard — focus management, tab order, keyboard shortcuts", "value": "keyboard"},
      {"label": "forms — labels, error messages, autocomplete, validation feedback", "value": "forms"}
    ]
  }
]</parameter>
</invoke>
