...
<parameter name="questions">[
  {
    "question": "Configure logic audit — what should we scan?",
    "header": "Target",
    "type": "text",
    "key": "target",
  ...
  },
  {
    ...
    "multiSelect": false,
    "options": [
      {"label": "Quick — core analyzers, critical bugs only (Recommended)", "value": "quick"},
      {"label": "Deep — all analyzers, includes lower-confidence findings", "value": "deep"},
  ...
  },
  {
    ...
    "optional": true,
    "options": [
      {"label": "edge — boundary conditions, off-by-one, empty inputs", "value": "edge"},
      {"label": "invariant — pre/post conditions, state consistency", "value": "invariant"},
      {"label": "flow — dead code, unreachable branches, missing returns", "value": "flow"},
      {"label": "type — implicit coercion, null propagation, type confusion", "value": "type"},
      {"label": "race — async patterns, shared state mutations, concurrency", "value": "race"}
    ]
  }
]</parameter>
</invoke>
