...
<parameter name="questions">[
  {
    "question": "Configure code quality audit — what should we scan?",
    "header": "Target",
    "type": "text",
    "key": "target",
  ...
  },
  {
    ...
    "multiSelect": false,
    "options": [
      {"label": "Quick — naming and duplication checks (Recommended)", "value": "quick"},
      {"label": "Deep — full quality scan including comment analysis", "value": "deep"}
    ]
  },
  {
  ...
  },
  {
    ...
    "optional": true,
    "options": [
      {"label": "naming — variable/function/class naming quality and consistency", "value": "naming"},
      {"label": "duplication — copy-pasted logic, near-duplicate functions, DRY violations", "value": "duplication"},
      {"label": "comments — dead code, stale comments, missing JSDoc, TODO accumulation", "value": "comments"}
    ]
  }
]</parameter>
</invoke>
