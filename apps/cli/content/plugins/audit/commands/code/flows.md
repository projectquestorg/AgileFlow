...
**If DEPTH, MODEL, or FLOWS were NOT explicitly provided as arguments**, use `AskUserQuestion` before starting:

```xml
<invoke name="AskUserQuestion">
<parameter name="questions">[
  {
    "question": "Configure flow integrity audit — what should we scan?",
    "header": "Target",
    "type": "text",
    "key": "target",
  ...
  },
  {
    ...
    "multiSelect": false,
    "options": [
      {"label": "Quick — core flow analyzers, critical broken journeys only (Recommended)", "value": "quick"},
      {"label": "Deep — all analyzers, includes degraded and warning flows", "value": "deep"},
  ...
  {
    "question": "Specific user flows to verify? (leave blank to auto-discover all)",
    "header": "Flows",
    "type": "text",
    "key": "flows",
    "placeholder": "e.g. signup,checkout,password-reset",
    "optional": true
  }
]</parameter>
</invoke>
...
**Skip this step if TARGET, DEPTH, MODEL, and FLOWS were all explicitly provided as arguments.**
