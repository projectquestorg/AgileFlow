...
<parameter name="questions">[
  {
    "question": "Configure test quality audit — what should we scan?",
    "header": "Target",
    "type": "text",
    "key": "target",
  ...
  },
  {
    ...
    "multiSelect": false,
    "options": [
      {"label": "Quick — coverage and fragility checks only (Recommended)", "value": "quick"},
      {"label": "Deep — all analyzers, includes maintenance and pattern analysis", "value": "deep"},
  ...
  },
  {
    ...
    "optional": true,
    "options": [
      {"label": "coverage — untested critical paths, missing error/catch tests", "value": "coverage"},
      {"label": "fragility — timing-dependent, order-dependent, flaky tests", "value": "fragility"},
      {"label": "mocking — over-mocking, mock leakage, testing mocks instead of code", "value": "mocking"},
      {"label": "assertions — weak assertions, missing negative cases, snapshot overuse", "value": "assertions"},
      {"label": "structure — missing nesting, unclear names, overly long test files", "value": "structure"},
      {"label": "integration — missing API tests, absent E2E, unit-only suites", "value": "integration"},
      {"label": "maintenance — dead tests, outdated assertions, commented-out tests", "value": "maintenance"},
      {"label": "patterns — testing private methods, deep mock chains, God test objects", "value": "patterns"}
    ]
  }
]</parameter>
</invoke>
