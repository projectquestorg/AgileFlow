...
describe("TAB_KEYBINDS", () => {
  ...
  it("Alt+w routes through __close-window callback (for undo support)", () => {
    // The callback probes the window's cwd before killing so
    // Alt+Shift+T can resurrect it later.
