---
title: Agents
description: 34 specialized AI agents for every aspect of software development. Each agent is an expert in their domain, ready to help with specific tasks.
---

# Agents

AgileFlow includes **34 specialized agents**, each an expert in their domain. Agents can be spawned by the `/babysit` mentor or invoked directly using the Task tool.
...
- **High** (9 agents): ui, database, ci, devops, testing, security, documentation, performance, codebase-query
- **Medium** (15 agents): datamigration, qa, accessibility, monitoring, research, adr-writer, analytics, integrations, mobile, design, compliance, refactor, product, readme-updater
