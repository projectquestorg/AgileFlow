...
- [`/sesión:estado`](/commands/session-status) - Ver sesiones activas actuales
- [`/sesión:fin`](/commands/session-end) - Finalizar y limpiar sesiones.
- [`/sesión:nueva`](/commands/session-new) - Crear nueva sesión
