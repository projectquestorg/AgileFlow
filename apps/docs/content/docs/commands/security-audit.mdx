...
/agileflow:audit:security app/

# Deep analysis with all 8 analyzers
/agileflow:audit:security . DEPTH=deep

# Focus on specific vulnerability areas
/agileflow:audit:security src/ FOCUS=injection,auth

# Single file input validation check
/agileflow:audit:security app/page.tsx FOCUS=input

# Comprehensive audit with all analyzers
/agileflow:audit:security . DEPTH=deep FOCUS=all

# API routes security analysis
/agileflow:audit:security app/api/ FOCUS=api
```
...
/agileflow:audit:security app/ FOCUS=injection

# Multiple specific areas
/agileflow:audit:security app/ FOCUS=injection,auth,secrets

# All analyzers
/agileflow:audit:security app/ FOCUS=all
```
...
| Command | Purpose |
|---------|---------|
| [`/logic:audit`](/docs/commands/logic-audit) | Logic bug analysis (similar multi-agent architecture) |
| [`/legal:audit`](/docs/commands/legal-audit) | Legal compliance analysis (similar architecture) |
| [`/performance:audit`](/docs/commands/performance-audit) | Performance bottleneck analysis |
| [`/test:audit`](/docs/commands/test-audit) | Test coverage and quality analysis |
