...
/agileflow:audit:test . DEPTH=deep

# Focus on specific test quality areas
/agileflow:audit:test __tests__/ FOCUS=coverage,fragility

# Single area analysis
/agileflow:audit:test __tests__/ FOCUS=fragility

# Comprehensive audit with all analyzers
/agileflow:audit:test . DEPTH=deep FOCUS=all
```
...
/agileflow:audit:test src/ FOCUS=coverage

# Multiple specific areas
/agileflow:audit:test src/ FOCUS=coverage,mocking,assertions

# All analyzers
/agileflow:audit:test src/ FOCUS=all
```
...
| [`/audit:performance`](/docs/commands/performance-audit) | Performance bottleneck analysis (similar multi-agent architecture) |
