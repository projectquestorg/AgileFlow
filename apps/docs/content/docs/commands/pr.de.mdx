...
Der Befehl wird:
1. Laden Sie die Geschichte von `docs/06-stories/US-0042.md`
2. Extrahieren Sie Akzeptanzkriterien, Abhängigkeiten und Kontext
...
- **Epic reference** - Zu welcher Funktion gehört das?
- **Story summary** - Was wurde umgesetzt
- **Dependencies** - Andere Geschichten, von denen es abhängt
- **Acceptance criteria** - Alle AC mit Kontrollkästchenstatus
- **Test evidence** - Ihre Testergebnisse und Verifizierung
- **Risk assessment** - Mögliche Auswirkungen und Rollback-Plan
- **Code owners** - Aus der CODEOWNERS-Datei
...
### Integration von Testnachweisen
...
1. **Summary** - Was wurde gebaut
2. **Linked Issues** - Story + Abhängigkeiten
3. **Checklist** - Status der Akzeptanzkriterien
4. **Test Evidence** - Wie es überprüft wurde
5. **Screenshots/GIFs** - Visueller Beweis (falls zutreffend)
6. **Risk Assessment** - Mögliche Auswirkungen + Rollback-Plan
7. **Code Owners** - Wer sollte überprüfen
...
### Verlinken Sie alle damit verbundenen Arbeiten
...
**Error**: Story-Datei existiert nicht
...
### „Problem mit der Formatierung der Akzeptanzkriterien“
...
- [`/babysitten`](/commands/babysit) - Implementierungsmentor (verwendet PR am Ende)
- [`/Geschichte`](/commands/story) - Erstellen Sie mit AC Geschichten, die Referenzen darstellen
- [`/rezension`](/commands/review) - Codeüberprüfung vor der PR
- [`/verify`](/commands/verify) - Führen Sie Tests zur Beweissicherung durch
- [`/impact`](/commands/impact) - PR-Auswirkungen analysieren
- [`/baseline`](/commands/baseline) - Markieren Sie die Funktion nach der Zusammenführung als abgeschlossen
