...
```bash
/agileflow:discovery:brief TOPIC="Mobile app" IDEATION=docs/08-project/ideation/ideation-20250214.md
```

With research findings:

```bash
/agileflow:discovery:brief TOPIC="Dashboard" RESEARCH=docs/10-research/research-dashboard.md,docs/10-research/ui-analysis.md
```
...
This can be used standalone (with existing ideation/research files) or as Phase 3 of the `/discovery:new` workflow.
...
```
1. Brainstorm
   /discovery:new TOPIC="..." DEPTH=quick

2. OR Use Existing Ideation
   /ideate:new SCOPE=all OUTPUT=report
   /discovery:brief TOPIC="..." IDEATION=docs/08-project/ideation/ideation-20250214.md

3. Add Research (Optional)
   /research:ask TOPIC="..."
   /research:import TOPIC="..."
   /discovery:brief TOPIC="..." RESEARCH=docs/10-research/...
...
- Users can track time in <10 seconds
- Invoices generated in <2 minutes
...
/discovery:brief TOPIC="..." IDEATION=docs/08-project/ideation/ideation-security.md,docs/08-project/ideation/ideation-ux.md
```
...
/discovery:brief TOPIC="..." IDEATION=...
...
- [`/discovery:new`](/commands/discovery-new) - Full discovery workflow (brainstorm + research + brief)
