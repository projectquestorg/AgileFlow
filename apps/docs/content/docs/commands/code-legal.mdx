...
/agileflow:legal:audit app/

# Deep analysis with all 9 analyzers
/agileflow:legal:audit . DEPTH=deep

# Focus on specific compliance areas
/agileflow:legal:audit src/ FOCUS=privacy,a11y

# Single file AI compliance check
/agileflow:legal:audit app/page.tsx FOCUS=ai

# Comprehensive audit with all analyzers
/agileflow:legal:audit . DEPTH=deep FOCUS=all
```
...
/agileflow:legal:audit app/ FOCUS=privacy,a11y,licensing

# All analyzers
/agileflow:legal:audit app/ FOCUS=all
```
