...
### Einfach – Überprüfen Sie den aktuellen Zweig
...
### Überprüfung gegenüber einer anderen Basis
...
## Struktur des Überprüfungsberichts
...
### Deckungslücken
- Ohne Tests hinzugefügte Zeilen
...
Schlagen Sie eine Ergänzung vor `.github/workflows/pr.yml`:
...
- **Show examples** - Fügen Sie ❌ SCHLECHTEN und ✅ GUTEN Code hinzu
...
- [`/babysitten`](/commands/babysit) - Implementierungsanleitung (führt Überprüfung vor PR durch)
