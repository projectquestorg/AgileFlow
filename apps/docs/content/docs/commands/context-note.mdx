...
For significant technical decisions, use [`/adr`](/commands/adr) instead.
...
- [`/context`](/commands/context) - Overview of context commands
- [`/context:full`](/commands/context-full) - Generate full context
- [`/context:export`](/commands/context-export) - Export concise excerpt
