...
### Verifique las dependencias de historias específicas
...
### Ruta crítica
**Shows**: La cadena de dependencia más larga de principio a fin.
...
**Shows**: Historias que bloquean la mayoría de los otros trabajos
...
### Escenario: Historia del camino crítico en riesgo
...
- **During sprint**: Monitorear la ruta crítica con `/board`
...
- **Monitor critical path** - Las historias en el camino crítico merecen especial atención.
...
- [`/correr`](/commands/sprint) - La planificación de Sprint respeta las dependencias.
- [`/tablero`](/commands/board) - Ver el progreso del sprint y los bloqueadores
- [`/bloqueadores`](/commands/blockers) - Seguimiento y resolución de historias bloqueadas.
- [`/validar historia`](/commands/story-validate) - Validar que existan dependencias.
- [`/métricas`](/commands/metrics) - Correlacionar el tiempo del ciclo con la profundidad de la dependencia.
