...
After using [`/research:ask`](/commands/research-ask) to get answers from external AI, this command:
...
- [`/research:analyze`](/commands/research-analyze) - Analyze existing research
