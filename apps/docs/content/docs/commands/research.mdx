...
- [`/babysit`](/commands/babysit) - Detects stuck situations and suggests research:ask
- [`/adr`](/commands/adr) - Create architecture decisions referencing research
- [`/epic`](/commands/epic) - Create epics based on research findings
- [`/story`](/commands/story) - Create stories with research references
