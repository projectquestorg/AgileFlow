...
Coordinate multiple domain experts to work together on complex multi-domain tasks.

- **Native team coordination** - Agent Teams work natively in Claude Code environments
- **Multi-domain orchestration** - Automatically delegate subtasks to specialists
- **Team templates** - Predefined teams for common patterns (fullstack, code-review, security)
- **Shared context** - Team members share understanding of goals and progress
- **Automatic synthesis** - Results synthesized into actionable next steps
...
| **Logic Audit** | Find logic bugs with consensus | `/agileflow:logic:audit [file]` |
