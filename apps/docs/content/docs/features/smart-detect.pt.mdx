...
Detecção inteligente é do AgileFlow **Contextual Feature Router** - um sistema que analisa automaticamente o estado do seu projeto e recomenda recursos relevantes no momento certo do seu fluxo de trabalho. Em vez de memorizar mais de 139 comandos, você trabalha naturalmente e o AgileFlow apresenta o que você precisa.
...
AgileFlow possui 139 comandos e 131 agentes. A maioria dos usuários conhece apenas alguns. A Detecção Inteligente resolve esse problema de descoberta:
...
4. **Recommending only what matters** - Apresentando de 2 a 5 sugestões contextuais, nem todos os 139 comandos
