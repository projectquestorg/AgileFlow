...
- **Claude Code**, **Cursor**, **Windsurf**, **OpenAI Codex CLI**, or **Antigravity**
...
See the [full command reference](/commands) for all 155 commands.
...
| OpenAI Codex CLI | Supported | `.codex/config.toml`, `.codex/skills/`, and `~/.codex/prompts/` |
| Antigravity | Supported | `.antigravity/skills/` |
...
# Antigravity
agileflow setup --ide antigravity
```
