---
title: Introduction
description: The AI-powered project management framework for Claude Code. Streamline your development workflow with intelligent agents, automated planning, and seamless collaboration.
---
...
| **Advanced** | `/council`, `/rpi`, `/rlm`, `/workflow`, `/batch`, `/choose`, `/legal:audit` |
| **Audits** | `/logic:audit`, `/audit:performance`, `/audit:test`, `/audit:security`, `/legal:audit` |

### 83 Specialized Agents
